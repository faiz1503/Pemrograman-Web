<%-- 
    Document   : EditTransaksiPenjualan
...
<%
    ...
    TransaksiPenjualan[] daftarTransaksiPenjualan = TransaksiPenjualanHome.getDaftarTransaksiPenjualan2(kodePusatOleh2);
                ...
                <div class="right_col" role="main">
                    <div class="">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <font size="5">Tabel Transaksi Penjualan</font>
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=TransaksiPenjualan.getHarga()%></td>
                                                <td><%=TransaksiPenjualan.getTglTransaksi()%></td>
                                                <td><%=TransaksiPenjualan.getLokasiPengiriman()%></td>
                                                <td><%=TransaksiPenjualan.getTglPengiriman()%></td>
                                                <td><center><img src="../../Gambar/<%=TransaksiPenjualan.getBuktiPembayaran()%>" width="100" height="100"></center></td>
                                                <td><%=TransaksiPenjualan.getKet()%></td>
                                        <td><center>
                                            <a href="FormEditTransaksiPenjualan2.jsp?kodeTransaksi=<%=TransaksiPenjualan.getKodeTransaksi()%>">Edit <img src="../../Gambar/Edit.png" height="20"></a> &nbsp | &nbsp
                                            <a href="../../DeleteTransaksi?kodeTransak=<%=TransaksiPenjualan.getKodeTransaksi()%>">Delete<img src="../../Gambar/Delete.png" height="20"></a>
                                        </center></td>
                                        </tr>
                                        <%}%>
                                        </tbody>
