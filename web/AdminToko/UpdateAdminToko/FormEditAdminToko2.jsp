                                ...
                                <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-1">
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../EditAdminToko2" method="post">

                                                <%--Tampilan form beserta input text --%>
                                                <input type="hidden" name="kodeAdminToko" value=<%=AdminToko2.getKodeAdminToko()%>>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Kode Pusat Oleh2</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="kodePusatOleh2" required="required"  readonly="readonly"class="form-control col-md-7 col-xs-12" value='<%=AdminToko2.getKodePusatOleh2()%>'>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Username </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="id" required="required" class="form-control col-md-7 col-xs-12" value='<%=AdminToko2.getId()%>'>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Password</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="password" name="password" required="required" class="form-control col-md-7 col-xs-12" value='<%=AdminToko2.getPassword()%>'>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="nama"  required="required" class="form-control col-md-7 col-xs-12" value='<%=AdminToko2.getNama()%>'>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="email" name="email" required="required" class="form-control col-md-7 col-xs-12" value='<%=AdminToko2.getEmail()%>'>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">No HP</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="noHP" required="required" class="form-control col-md-7 col-xs-12" value='<%=AdminToko2.getNoHP()%>'>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Gambar</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <%=AdminToko2.getGambar()%>
                                                        <input type="file" required id="myFile" name="gambar" value="D:\ProjectPWEB\web\Gambar\<%=AdminToko2.getGambar()%>" required>
                                                    </div>
                                                </div>
                                        </div>
                                        </form>
