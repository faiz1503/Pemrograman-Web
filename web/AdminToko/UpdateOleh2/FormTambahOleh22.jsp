                        ...
                        <div class="row">
                            <div class="center">
                                <div class="col-md-7 col-sm-12 col-xs-12 col-md-offset-1">
                                    ...
                                    <div class="x_panel">
                                        <br>
                                        <center><font size="5">Form Tambah Oleh2</font></center>

                                        <div class="x_content">
                                            <br />
                                            <br>

                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../AddOleh22" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" name="harga" min="0" required="required" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Gambar</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="file" id="myFile" placeholder="Masukkan Gambar" name="gambar">
                                                    </div>
                                                </div>
                                        </div>
                                        </form>
