                        ...
                        <div class="row">       
                            <div class="center">
                                <div class="col-md-11 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_panel">
                                        <br>
                                        <center><font size="5">Form Tambah Pusat Oleh</font></center>

                                        <div class="x_content">
                                            <br />
                                            <br>

                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../AddPusatOleh2" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" name="noHPToko" required="required" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
