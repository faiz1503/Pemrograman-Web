                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><center><img src="../../Gambar/<%=Member.getGambar()%>" width="100" height="100"></center></td>
                                                <td><%=Member.getNama()%></td>
                                                <td><%=Member.getJk()%></td>
                                                <td><%=Member.getTempatLahir()%></td>
                                                <td><%=Member.getTglLahir()%></td>
                                                <td><%=Member.getAlamat()%></td>
                                                <td><%=Member.getEmail()%></td>
                                                <td><%=Member.getNoHP()%></td>


                                                <td>
                                                    <a href="FormEditMember.jsp?kodeMember=<%=Member.getKodeMember()%>">Edit <img src="../../Gambar/Edit.png" height="20"></a> &nbsp | &nbsp
                                                    <a href="../../DeleteMember?kodeMember=<%=Member.getKodeMember()%>">Delete<img src="../../Gambar/Delete.png" height="20"></a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
