                        ...
                        <div class="row">       
                            <div class="center">
                                <div class="col-md-11 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_panel">
                                        <br>
                                        <center><font size="5">Form Tambah Artikel</font></center>

                                        <div class="x_content">
                                            <br />
                                            <br>

                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../AddArtikel" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10 col-sm-6 col-xs-12">
                                                        <div class="left">
                                                            <textarea name="isi" id="editor1" rows="2" cols="80" placeholder="Ketikkan artikel anda disini"></textarea>
                                                        </div>
                                                        <script>
