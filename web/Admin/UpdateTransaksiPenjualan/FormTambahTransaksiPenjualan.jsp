                                            ...
                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../AddTransaksiPenjualan" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <select name="kodeOleh2" height="10" style="height:30px;" required>
                                                            <option value="">- Pilih kode pusat oleh2 -</option>
                                                            <%
                                                                for (int i = 0; i < daftarTransaksiPenjualan.length; i++) {
                                                                    transaksiPenjualan = daftarTransaksiPenjualan[i];
                                                            %>
                                                            <option value="<%=transaksiPenjualan.getKodeOleh2()%>"><%=transaksiPenjualan.getKodeOleh2()%></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" name="jumlahBeli" id="harga_javascript" min="0" required="required" class="form-control col-md-7 col-xs-12" onchange="total()">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Total Harga</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" name="totalHarga" id="total" readonly min="0" required="required" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <div class="col-md-13 xdisplay_inputx form-group has-feedback">
                                                                        <input type="text" class="form-control has-feedback-left" id="single_cal1" disabled="disabled" placeholder="Tanggal transaksi" aria-describedby="inputSuccess2Status"  name="tglTransaksi">
