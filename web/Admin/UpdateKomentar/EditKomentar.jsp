...
<jsp:useBean id="Komentar"  class="Model.Komentar"/>
<jsp:useBean id="KomentarHome" class="Model.KomentarHome"/>

<%Komentar komentar = null;
    Komentar[] daftarKomentar = KomentarHome.getDaftarKomentar();
%>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <%
                                                for (int i = 0; i < daftarKomentar.length; i++) {
                                                    Komentar = daftarKomentar[i];
                                            %>


                                            <tr>
                                                <td><%=i + 1%></td>
                                                <td><%=Komentar.getKodeKomentar()%></td>
                                                <td><%=Komentar.getKodeMember()%></td>
                                                <td><%=Komentar.getKodeArtikel()%></td>
                                                <td><%=Komentar.getTgl()%></td>
                                        <td><center>
                                            <a href="../../DeleteKomentar?kodeArtikel=<%=Komentar.getKodeArtikel()%>">Delete<img src="../../Gambar/Delete.png" height="20"></a>
                                        </center></td>
                                        <td><%=Komentar.getIsiKomentar()%></td>
                                    </tr>
                                    <%}%>
                                        </tbody>
                                    </table>
