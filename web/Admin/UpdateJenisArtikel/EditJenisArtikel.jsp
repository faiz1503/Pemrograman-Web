...
<%String jenis=request.getParameter("jenis");
    ...
    Artikel[] daftarArtikel = ArtikelHome.getDaftarArtikel(jenis);
%>
                ...
                <div class="right_col" role="main">
                    <div class="">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <font size="5"><%=jenis%></font>
                                    &nbsp  <font color="blue"><a href="FormTambahJenisArtikel.jsp?jenis=<%=jenis%>">Tambah</a></font>
                                ...
                                <div class="x_content">
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <%
                                                for (int i = 0; i < daftarArtikel.length; i++) {
                                                    Artikel = daftarArtikel[i];
                                            %>


                                            <tr>
                                                <td><%=i + 1%></td>
                                                <td><%=Artikel.getKodeArtikel()%></td>
                                                <td><%=Artikel.getJudul()%></td>
                                                <td><center><img src="../../Gambar/<%=Artikel.getGambar()%>" width="100" height="100"></center></td>

                                        <td><%=Artikel.getKategori()%></td>
                                        <td><center>
                                            <a href="FormEditJenisArtikel.jsp?kodeArtikel=<%=Artikel.getKodeArtikel()%>&jenis=<%=Artikel.getJenis()%>">Edit <img src="../../Gambar/Edit.png" height="20"></a> &nbsp | &nbsp
                                            <a href="../../DeleteJenisArtikel?kodeArtikel=<%=Artikel.getKodeArtikel()%>&jenis=<%=Artikel.getJenis()%>">Delete<img src="../../Gambar/Delete.png" height="20"></a>
                                        </center></td>
                                        <td><%=Artikel.getIsi()%></td>
                                        </tr>
                                        <%}%>
                                        </tbody>
                                    </table>
