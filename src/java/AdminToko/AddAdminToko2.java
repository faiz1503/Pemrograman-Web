 ...
 * @author DeysiFortuna
 */
@WebServlet(name = "AddAdminToko2", urlPatterns = {"/AddAdminToko2"})
public class AddAdminToko2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (adminTokoBean.create(adminToko) == true) {
                response.sendRedirect("Admin/Login/LoginAdmin.jsp");
            } else {
                response.sendRedirect("Admin/Login/LoginAdmin.jsp#signup");
