 ...
 * @author DeysiFortuna
 */
@WebServlet(name = "AddOleh22", urlPatterns = {"/AddOleh22"})
public class AddOleh22 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (oleh2Bean.create(oleh2) == true) {
                ...
                response.sendRedirect("AdminToko/UpdateOleh2/FormTambahOleh22.jsp");
