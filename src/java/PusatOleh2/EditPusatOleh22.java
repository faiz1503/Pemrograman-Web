 ...
 * @author DeysiFortuna
 */
@WebServlet(name = "EditPusatOleh22", urlPatterns = {"/EditPusatOleh22"})
public class EditPusatOleh22 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (memberBean.store(poleh2) == true) {
                ...
                response.sendRedirect("AdminToko/UpdateAdminToko/FormEditPusatOleh22.jsp");
