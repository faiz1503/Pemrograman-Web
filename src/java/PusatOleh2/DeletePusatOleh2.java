 ...
 * @author DeysiFortuna
 */
@WebServlet(name = "DeletePusatOleh2", urlPatterns = {"/DeletePusatOleh2"})
public class DeletePusatOleh2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (memberBean.delete(kodePusatOleh2) == true) {
