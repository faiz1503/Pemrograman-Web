                        ...
                        <div class="row">
                            <div class="center">
                                <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-1">
                                    ...
                                    <div class="x_panel">
                                        <br>
                                        <center><font size="5">Form Tambah Admin Toko</font></center>

                                        <div class="x_content">
                                            <br />
                                            <br>

                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../AddAdminTokoAction" method="post">

                                                <%--Tampilan form beserta input text --%>
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Kode Pusat Oleh2</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="kodePusatOleh2" required="required" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                ...
                                <div class="right_col" role="main">
                                    <div class="col-md-6 col-sm-10 col-xs-10">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <table id="datatable-responsive" class="table responsive table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th>No</th>
