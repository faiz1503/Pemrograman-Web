                                ...
                                <div class="col-md-5 col-sm-12 col-xs-12 col-md-offset-1">
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../EditOleh2" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name="kodePusatOleh2" required="required" class="form-control col-md-7 col-xs-12" value=<%=Oleh2.getKodePusatOleh2()%>>
                                                    </div>
                                                </div>
                                                <div class="form-group">
