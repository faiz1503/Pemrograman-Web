...
<%Oleh2 artikel = null;
    Oleh2[] daftarOleh2 = Oleh2Home.getDaftarOleh2();
%>
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><center>
                                                    <a href="FormEditOleh2.jsp?kodeOleh2=<%=Oleh2.getKodeOleh2()%>">Edit <img src="../../Gambar/Edit.png" height="20"></a> &nbsp | &nbsp
                                                    <a href="../../DeleteOleh2?kodeOleh2=<%=Oleh2.getKodeOleh2()%>">Delete<img src="../../Gambar/Delete.png" height="20"></a>
                                        </center></td>
                                            </tr>
                                            <%}%>
                                        </tbody>
