...
<%TransaksiPenjualan transaksi = null;
    TransaksiPenjualan[] daftarTransaksiPenjualan = TransaksiPenjualanHome.getDaftarTransaksiPenjualan();
%>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <td><center>
                                            <a href="FormEditTransaksiPenjualan.jsp?kodeTransaksi=<%=TransaksiPenjualan.getKodeTransaksi()%>">Edit <img src="../../Gambar/Edit.png" height="20"></a> &nbsp | &nbsp
