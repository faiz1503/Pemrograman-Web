...
<%String jenis=request.getParameter("jenis");
    ...
    Artikel[] daftarArtikel = ArtikelHome.getDaftarArtikel();
%>
                ...
                <div class="right_col" role="main">
                    <div class="">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <font size="5">Artikel</font>
                                    &nbsp  <font color="blue"><a href="FormTambahArtikel.jsp">Tambah</a></font>
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=Artikel.getJenis()%></td>
                                                <td><%=Artikel.getJudul()%></td>
                                                <td><center><img src="../../Gambar/<%=Artikel.getGambar()%>" width="100" height="100"></center></td>

                                        <td><%=Artikel.getKategori()%></td>
                                        <td><center>
                                            <a href="FormEditArtikel.jsp?kodeArtikel=<%=Artikel.getKodeArtikel()%>">Edit <img src="../../Gambar/Edit.png" height="20"></a> &nbsp | &nbsp
                                            <a href="../../DeleteArtikel?kodeArtikel=<%=Artikel.getKodeArtikel()%>">Delete<img src="../../Gambar/Delete.png" height="20"></a>
                                        </center></td>
