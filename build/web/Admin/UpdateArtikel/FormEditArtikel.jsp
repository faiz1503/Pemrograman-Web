...
%>
<%
    Artikel[] daftarArtikel = ArtikelHome.getDaftarJenis();
%>
                        ...
                        <div class="row">       
                            <div class="center">
                                <div class="col-md-11 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_panel">
                                        <br>
                                        <center><font size="5">Form Edit Artikel</font></center>

                                        <div class="x_content">
                                            <br />
                                            <br>

                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../EditArtikel" method="post">
                                                <input type="hidden" name="kodeArtikel" value=<%=Artikel.getKodeArtikel()%>>
                                                
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">Jenis Artikel</label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <!--<input type="text" name="kategori" required="required" class="form-control col-md-7 col-xs-12">-->

                                                        <font size="3px" color="grey">
                                                        <select name="jenis" height="10" style="height:30px;" required>
                                                            <option value="<%=Artikel.getJenis()%>"><%=Artikel.getJenis()%></option>
                                                            <%
                                                                for (int i = 0; i < daftarArtikel.length; i++) {
                                                                    Artikel2 = daftarArtikel[i];
                                                            %>
                                                            <option value="<%=Artikel2.getJenis2()%>"><%=Artikel2.getJenis2()%></option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                                                <a href="EditArtikel.jsp"><button class="btn btn-primary" type="button" form="form1">Cancel</button></a>
