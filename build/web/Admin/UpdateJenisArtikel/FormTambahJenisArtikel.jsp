                        ...
                        <div class="row">       
                            <div class="center">
                                <div class="col-md-11 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_panel">
                                        <br>
                                        <center><font size="5">Form Tambah <%=jenis%></font></center>

                                        <div class="x_content">
                                            <br />
                                            <br>

                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../AddJenisArtikel" method="post">
