...
<%
    ...
    if (kodeMember != null) {
        Member = MemberHome.getDaftarMemberByKode(kodeMember);
    }
%>
                        ...
                        <div class="row">       
                            <div class="center">
                                <div class="col-md-11 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_panel">
                                        <br>
                                        <center><font size="5">Form Edit Member</font></center>

                                        <div class="x_content">
                                            <br />
                                            <br>

                                            <form id="form1" data-parsley-validate class="form-horizontal form-label-left" action="../../EditMember" method="post">

                                                <%--Tampilan form beserta input text --%>
                                                <input type="hidden" name="kodeMember" value=<%=Member.getKodeMember()%>>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">Username </label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" name="id" required="required" class="form-control col-md-7 col-xs-12" value='<%=Member.getId()%>'>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">Password</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="password" name="password" required="required" class="form-control col-md-7 col-xs-12" value='<%=Member.getPassword()%>'>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" name="nama"  required="required" class="form-control col-md-7 col-xs-12" value='<%=Member.getNama()%>' >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div id="gender" class="btn-group" data-toggle="buttons">
                                                                <c:set var="JK" value="<%=Member.getJk()%>"/>
                                                                <c:choose>
                                                                    <c:when test="{JK eq Laki-laki}">
                                                                    ...
                                                                    <c:otherwise>
                                                                        <input type="radio" class="flat" name="jk" value="Laki-laki"  /> &nbsp <font size="3">Laki-laki </font>&nbsp
                                                                        <input type="radio" class="flat" name="jk" value="Perempuan" checked="" required />&nbsp <font size="3">Perempuan</font>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" name="tempatLahir" required="required" class="form-control col-md-7 col-xs-12" value='<%=Member.getTempatLahir()%>'>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-15">
                                                        ...
                                                        <fieldset>
                                                            <%
                                                                String dateStringInOriginalFormat = Member.getTglLahir();
                                                                ...
                                                                Member.setTglLahir(dateStringInNewFormat);
                                                            ...
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <div class="col-md-12 xdisplay_inputx form-group has-feedback">
                                                                        <input type="text" class="form-control has-feedback-left" id="single_cal1" placeholder="Tanggal" aria-describedby="inputSuccess2Status"  name="tglLahir" value=<%=Member.getTglLahir()%>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" name="alamat" required="required" class="form-control col-md-7 col-xs-12" value=<%=Member.getAlamat()%>>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">Email</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="email" name="email" required="required" class="form-control col-md-7 col-xs-12" value=<%=Member.getEmail()%>>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4 col-sm-3 col-xs-12">No HP</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <input type="text" name="noHP" required="required" class="form-control col-md-7 col-xs-12" value=<%=Member.getNoHP()%>>
                                                        </div>
                                                    </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <%=Member.getGambar()%>
                                                        <input type="file" required id="myFile" name="gambar" value="D:\ProjectPWEB\web\Gambar\<%=Member.getGambar()%>" required>
                                                    </div>
                                                </div>
                                                </div>
                                            </form>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                                                    <a href="EditMember.jsp"><button class="btn btn-primary" type="button">Cancel</button></a>
